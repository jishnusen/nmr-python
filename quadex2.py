...
class Quadex:
    ...
    def plot(self, sqn, vlf, eta1, eqqh1, cs1, t2one, npolar1, nazim1,
             ...
             jfreq, user_data):
        self.f, self.g = self.quadex2(sqn, vlf, eta1, eqqh1, cs1, t2one, npolar1, nazim1,
                                      eta2, eqqh2, cs2, t2two, npolar2, nazim2, hi, lo,
                                      jfreq)
    ...
    @staticmethod
    def quadex2(sqn, vlf, eta1, eqqh1, cs1, t2one, npolar1, nazim1,
                eta2, eqqh2, cs2, t2two, npolar2, nazim2, hi, lo,
                jfreq):
        npts = 1000
        f = np.zeros(npts)
        ...
        freq1 = Quadex.quadfreq(npolar1, nazim1, cs1, eta1, eqqh1, vlf, sqn)
        freq2 = Quadex.quadfreq(npolar2, nazim2, cs2, eta2, eqqh2, vlf, sqn)
