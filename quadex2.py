import fortran_90_ports.quadexfort as fort
import numpy as np
import matplotlib.pyplot as plt


def run():
    print("Running Two-Site Quadrupolar Static Exchange Simulation")
    ...
    f, g = fort.quadex2(sqn, vlf, eta1, eqqh1, cs1, t2one, npolar1, nazim1,
